package com.strde.common.utils;
...
public class FileUtils {
     ...
     * @throws IOException
     */
    public static HttpServletResponse getFlow(HttpServletResponse response, String filePath)
        throws IOException {
        // 读取路径下面的文件
     ...
     * @throws IOException
     */
    private static HttpServletResponse getResponse(HttpServletResponse response, String filePath)
        throws IOException {
     ...
     * @throws IOException
     */
    private static HttpServletResponse getResponse(HttpServletResponse response, String fileName, Long size)
        throws IOException {
        // 清空response
        response.reset();
        // 设置response的Header
