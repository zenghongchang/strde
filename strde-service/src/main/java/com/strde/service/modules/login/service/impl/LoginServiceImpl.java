package com.strde.service.modules.login.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.strde.common.exception.RunException;
import com.strde.common.utils.Constant;
import com.strde.service.modules.captcha.service.CaptchaService;
...
import com.strde.service.modules.system.token.service.TokenService;
...
public class LoginServiceImpl implements LoginService {
    ...
    public TokenEntity login(LoginVo loginVo) {
        ...
        QueryWrapper<AdminEntity> wrapper = new QueryWrapper<AdminEntity>().eq("username", loginVo.getUsername());
